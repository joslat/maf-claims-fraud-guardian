...
/// <summary>
/// Claims Fraud Detection Workflow - DevUI Version
/// 
/// DevUI-enabled version of the Claims Fraud Detection Workflow that:
/// - Provides browser-based workflow visualization and interaction
...
/// - Implements Chat Protocol pattern for DevUI compatibility
/// 
...
/// - Failsafe input executor with support for scenario selection
/// - Real-time streaming updates for DevUI visualization
/// 
/// Pipeline Stages:
/// 1. FailsafeInputExecutor - Handles DevUI input (scenarios or JSON)
/// 2. DataReviewExecutor - Initial data quality and completeness check
/// 3. ClassificationRouter - Routes to appropriate claim type handler
/// 4. PropertyTheftFanOut - Sends claim to 3 parallel fraud detection agents
/// 5. FraudAggregatorExecutor - Collects findings (fan-in), stores in state
/// 6. FraudDecisionExecutor - Analyzes aggregated data and makes final determination
/// 7. OutcomePresenterExecutor - Generates professional email to case handler
/// 
/// DevUI Features:
/// - Interactive scenario selection (1-3 or JSON input)
/// - Real-time agent output streaming
/// - Workflow state inspection
/// - Visual representation of fan-out/fan-in execution
/// </summary>
internal static class ClaimsFraudDetectionWorkflow_DevUI
{
    // --------------------- Shared state ---------------------
    ...
    public static async Task Execute(int scenario = 1)
    {
        ...
        WorkflowVisualizerTool.PrintAll(workflow, "Claims Fraud Detection Workflow - DevUI");
